...
public class App {
    public static void main(String[] args) throws Exception { 
        ...
        for(Map<String,String> films : filmsList) { //esta pegando no Map string e indicando que mostraremos os filmes
            ...
            String urlImage = films.get("image");
            String titulo = films.get("title");
            double classificacao = Double.parseDouble(films.get("imDbRating"));

            String textoFigurinha;
            if(classificacao >= 8.2){
                textoFigurinha = "É DENTRO!";
            }
            else {
                textoFigurinha = "É PAIA";
            }
